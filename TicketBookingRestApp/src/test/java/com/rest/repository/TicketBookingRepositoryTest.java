...
public class TicketBookingRepositoryTest {
	...
	public void testSaveTicket() {
		...
		Ticket getFromDb = ticketBookingRepository.findOne(savedInDb.getTicketId());
	...
	public void testGetTicketById() {
		...
		// Get Ticket from DB
		Ticket ticketFromInDb = ticketBookingRepository.findOne(ticketSavedInDb.getTicketId());
	...
	public void testFindByEmail() {
		...
		Ticket getFromDb = ticketBookingRepository.findByEmail("martin.s2017@gmail.com");
