...
public class TicketBookingServiceTest {
	...
	public void testGetTicketById() {
		...
		Mockito.when(ticketBookingRepository.findOne(1)).thenReturn(ticket);
	...
	public void testDeleteTicket() {
		...
		Mockito.when(ticketBookingRepository.findOne(1)).thenReturn(ticket);
		Mockito.when(ticketBookingRepository.exists(ticket.getTicketId())).thenReturn(false);
		assertFalse(ticketBookingRepository.exists(ticket.getTicketId()));
	}
